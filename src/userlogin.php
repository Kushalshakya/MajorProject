    ...
    <div class="login-cover">
        <div class="login-form">
            ...
            <form>
                ...
                <input type="submit" value="Log In" class="access">
            </form>
            <h3>New User? <a href="./user.php">Sign Up</a></h3>
            <h3><a href="../index.php" style="color : #1e1e3e;">Back to the Home Page</a></h3>
        </div>
    </div>

    <?php
        mysqli_query($db,"SELECT * from `users` WHERE email='$_POST[email]' && password='$_POST[password]';");
    ?>
    <!-- <div id="login-error">
