...
<head>
    ...
    <title>E-Library | Admin Newsletter</title>
    <link rel="stylesheet" href="dashboard_style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="icon" href="../assets/logo/android-chrome-512x512.png">
</head>
<style>
    #newsletter-admin .newsletter-container{
        margin : 20px 40px;
    }
    #newsletter-admin table,tr,td,th{
    ...
    #newsletter-admin td:nth-child(1){
        text-align : center;
        width : 10%;
    }
    th:nth-child(2){
    ...
    #newsletter-admin td:nth-child(2){
        width : 50%;
    }
    .upload_newsletter{
        width : 97.5%;
    ...
    <div id="newsletter-admin">
      <div class="newsletter-container">
        <?php
          ...
          $newsletter_data = "SELECT * FROM `newsletter`;";
          $newsletter_connect = mysqli_query($database,$newsletter_data);
          ...
          echo "<table>";
            ...
            while($news_data = mysqli_fetch_assoc($newsletter_connect)){
              echo "<tr>";
                echo "<td>"; echo $news_data['id']; echo "</td>";
                echo "<td>"; echo $news_data['email']; echo "</td>";
              echo "</tr>";
            }
          echo "</table>";

          $ns_data = mysqli_fetch_assoc($newsletter_connect);
        ?>
      </div>
      <div class="upload_newsletter">
        <button class="preview">Preview Newsletter</button>
        <button><a href="">Send Newsletter</a></button>
      </div>
    </div>
  </body>
  <script src="./adminscripts/newsletter.js" defer type="text/javascript"></script>
