...
<head>
    ...
    <title>E-Library | Admin Notes</title>
...
<style>
  ...
  #dashboard .dashboard-b td:nth-child(1){
  width : 15%;
  }
  #dashboard .dashboard-b td:nth-child(2){
    width : 40%;
  }
  #dashboard .dashboard-b td:nth-child(3){
    width : 30%;
  }
  #dashboard .dashboard-b td:nth-child(4){
    width : 15%;
    text-align : center;
  }
  #dashboard .dashboard-b td:nth-child(4) button{
      ...
      <div id="dashboard">
        <div class="upload_note">
          ...
          <form method="post" class="upload-form">
                <input name="upload_topic" type="text" placeholder="Note Topic" required spellcheck="false" autocomplete="off">
                <input name="upload_faculty" type="text" placeholder="Faculty" required spellcheck="false" autocomplete="off">
        ...
        <?php
          ...
          if(isset($_POST['upload'])){
              mysqli_query($db , "INSERT INTO `papers` VALUES ('','$_POST[upload_topic]','$_POST[upload_faculty]','$_POST[upload_file]');");
          ...
          <div class="dashboard-cover">
            <div class="dashboard-search">
              <form action="" method="post">
                <input type="search" placeholder='Search for notes' name="search_input" autocomplete="off" spellcheck="false">
                <button name="search_button"><i class='fa fa-search'></i></button>
              </form>
            </div>
            <div class="dashboard-b">
              <?php
                $paper_dbconnect = mysqli_connect('localhost','root','','elibrary');
                $paper_content = "SELECT * FROM `papers`";
                $paper_query = mysqli_query($paper_dbconnect,$paper_content);


                if(isset($_POST['search_button'])){
                  $note_search= mysqli_query($paper_dbconnect,"SELECT * FROM `papers` WHERE name LIKE'%$_POST[search_input]%'");
                  if(mysqli_num_rows($note_search) == 0){
                  ...
                  echo "<table>";
                    ...
                    echo "</tr>";
                    while($result = mysqli_fetch_assoc($note_search)){
                      $down = $result['name'];
                      $pdf = base64_encode($result["file"]);
                      echo "<tr>";
                        echo "<td>"; echo $result['id']; echo "</td>";
                        echo "<td>"; echo $result['name']; echo "</td>";
                        echo "<td>"; echo $result['faculty']; echo "</td>";
                        echo "<td>"; echo '<a href="data:application/pdf;base64,' . $pdf . '" download="'.$down.'"><button>Download</button></a>'; echo "</td>";
                      echo "</tr>";
                    }
                  echo "</table>";
                  }
                  ...
                  echo "<table>";
                    ...
                    while($result = mysqli_fetch_assoc($paper_query)){
                      $down = $result['name'];
                      $pdf = base64_encode($result["file"]);
                      echo "<tr>";
                        echo "<td>"; echo $result['id']; echo "</td>";
