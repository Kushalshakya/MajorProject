...
<head>
    ...
    <title>E-Library | Admin Donation</title>
...
<style>
    ...
    #donation-admin td:nth-child(1){
        width : 20%;
    }
    #donation-admin td:nth-child(2){
        width : 40%;
    }
    #donation-admin td:nth-child(3){
        width : 20%;
    }
    #donation-admin td:nth-child(4){
        width : 10%;
    }
    #donation-admin button{
...
<body>
    ...
    <div id="donation-admin">
      <div class="donation-container">
        <?php
          $database = mysqli_connect('localhost','root','','elibrary');
          $donation_data = "SELECT * FROM `donate`;";
          $donation_connect = mysqli_query($database,$donation_data);
          ...
          echo "<table>";
            ...
            while($donate_data = mysqli_fetch_assoc($donation_connect)){
              $down = $donate_data['name'];
              $pdf = base64_encode($donate_data['file']);
              echo "<tr>";
                echo "<td>"; echo $donate_data['date']; echo "</td>";
                echo "<td>"; echo $donate_data['name']; echo "</td>";
                echo "<td>"; echo $donate_data['faculty']; echo "</td>";
  ...
  <script src="./adminscripts/donation.js" defer type="text/javascript"></script>
