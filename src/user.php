...
<head>
    ...
    <title>E-Library | Create an Account</title>
    ...
    <div class="login-cover">
        <div class="login-form">
            ...
            <form method="post">
                ...
                <input type="number" placeholder="Phone Number" name="phonenumber" autocomplete="off">
                <input type="email" placeholder="Email" required name="email" autocomplete="off">
                <input type="date" placeholder="DOB" required name="dob" autocomplete="off">
                <input type="password" placeholder="Password" required name="password" autocomplete="off">
                <input type="submit" value="Sign Up" class="access" name="create">
            </form>
            <h3>Already a User? <a href="./userlogin.php">Login</a></h3>
            <h3><a href="../index.php" style="color : #1e1e3e;">Back to the Home Page</a></h3>
        </div>
    </div>
    <div id="login-error">
